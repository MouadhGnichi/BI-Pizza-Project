...
package projet_siad_pizza.dim_restau_0_1;
 ...
 * @status
 */
public class dim_restau implements TalendJob {
	...
	private final String jobName = "dim_restau";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dim_restau.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_PROJET_SIAD_PIZZA_dim_restau = new byte[0];
		static byte[] commonByteArray_PROJET_SIAD_PIZZA_dim_restau = new byte[0];
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + (int) this.sk_restau;
		...
		public boolean equals(Object obj) {
			...
			if (this.sk_restau != other.sk_restau)
				return false;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJET_SIAD_PIZZA_dim_restau.length) {
					if (length < 1024 && commonByteArray_PROJET_SIAD_PIZZA_dim_restau.length == 0) {
						commonByteArray_PROJET_SIAD_PIZZA_dim_restau = new byte[1024];
					} else {
						commonByteArray_PROJET_SIAD_PIZZA_dim_restau = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJET_SIAD_PIZZA_dim_restau, 0, length);
				strReturn = new String(commonByteArray_PROJET_SIAD_PIZZA_dim_restau, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJET_SIAD_PIZZA_dim_restau) {
		...
		public int compareTo(out1Struct other) {
			...
			returnValue = checkNullsAndCompare(this.sk_restau, other.sk_restau);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tDBOutput_1 = "dim_restau";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:LzZ0jyzSPjVq/xVaEAYM9OD5vXq+N92lc4susA==");
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables("dw_projet_pizza", null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equalsIgnoreCase("dim_restau")) {
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
								+ "`(`sk_restau` INT(20)   not null ,`id` VARCHAR(20)   not null ,`address` VARCHAR(39)  ,primary key(`sk_restau`))");
					}
				}
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement("SELECT COUNT(1) FROM `" + "dim_restau" + "` WHERE `sk_restau` = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO `" + "dim_restau"
						+ "` (`sk_restau`,`id`,`address`) VALUES (?,?,?)";

				java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement(insert_tDBOutput_1);
				resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
				String update_tDBOutput_1 = "UPDATE `" + "dim_restau"
						+ "` SET `id` = ?,`address` = ? WHERE `sk_restau` = ?";
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:5/RvIi5oDpF0jXboeQiU2uLCwOEltOeIwjr/7Q==");
...
// # Output table : 'out1'
							out1_tmp.sk_restau = Numeric.sequence("s1", 1, 1);
							out1_tmp.id = row1.id;
...
// Start of branch "out1"
						if (out1 != null) {
							...
							pstmt_tDBOutput_1.setInt(1, out1.sk_restau);
							...
							if (checkCount_tDBOutput_1 > 0) {
								...
								if (out1.address == null) {
									...
									pstmtUpdate_tDBOutput_1.setString(2, out1.address);
								}

								pstmtUpdate_tDBOutput_1.setInt(3 + count_tDBOutput_1, out1.sk_restau);
								...
								pstmtInsert_tDBOutput_1.setInt(1, out1.sk_restau);
								...
								if (out1.address == null) {
									...
									pstmtInsert_tDBOutput_1.setString(3, out1.address);
								}
...
// ###############################      
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:p2Suq+CtbU9CTvvYS5kwSJ89UMvof9e/Ij3vOQ==");
				...
				String dbquery_tDBInput_2 = "SELECT \n  `restaurants`.`id`, \n  `restaurants`.`dateAdded`, \n  `restaurants`.`dateUpdated`, \n  `restaurants`.`address`,"
						+ " \n  `restaurants`.`categories`, \n  `restaurants`.`primaryCategories`, \n  `restaurants`.`city`, \n  `restaurants`.`country"
						+ "`, \n  `restaurants`.`keys`, \n  `restaurants`.`latitude`, \n  `restaurants`.`longitude`, \n  `restaurants`.`menuPageURL`, \n"
						+ "  `restaurants`.`menus_amountMax`, \n  `restaurants`.`menus_amountMin`, \n  `restaurants`.`menus_currency`, \n  `restaurant"
						+ "s`.`menus_dateSeen`, \n  `restaurants`.`menus_description`, \n  `restaurants`.`menus_name`, \n  `restaurants`.`name`, \n  `r"
						+ "estaurants`.`postalCode`, \n  `restaurants`.`priceRangeCurrency`, \n  `restaurants`.`priceRangeMin`, \n  `restaurants`.`pri"
						+ "ceRangeMax`, \n  `restaurants`.`province`, \n  `restaurants`.`Column24`, \n  `restaurants`.`Column25`, \n  `restaurants`.`Co"
						+ "lumn26`, \n  `restaurants`.`Column27`, \n  `restaurants`.`Column28`, \n  `restaurants`.`Column29`, \n  `restaurants`.`Column"
						+ "30`, \n  `restaurants`.`Column31`, \n  `restaurants`.`Column32`, \n  `restaurants`.`Column33`, \n  `restaurants`.`Column34`\n"
						+ "FROM `restaurants`";
	...
	public static void main(String[] args) {
		final dim_restau dim_restauClass = new dim_restau();

		int exitCode = dim_restauClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dim_restau.class.getClassLoader()
					.getResourceAsStream("projet_siad_pizza/dim_restau_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dim_restau.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dim_restau");
		}
...
/************************************************************************************************
 * 119696 characters generated by Talend Open Studio for Data Integration on the
 * January 2, 2022 10:49:08 PM WAT
 ************************************************************************************************/