...
package projet_siad_pizza.dim_lieu_0_1;
 ...
 * @status
 */
public class dim_lieu implements TalendJob {
	...
	private final String jobName = "dim_lieu";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(dim_lieu.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_PROJET_SIAD_PIZZA_dim_lieu = new byte[0];
		static byte[] commonByteArray_PROJET_SIAD_PIZZA_dim_lieu = new byte[0];
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + (int) this.sk_lieu;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJET_SIAD_PIZZA_dim_lieu.length) {
					if (length < 1024 && commonByteArray_PROJET_SIAD_PIZZA_dim_lieu.length == 0) {
						commonByteArray_PROJET_SIAD_PIZZA_dim_lieu = new byte[1024];
					} else {
						commonByteArray_PROJET_SIAD_PIZZA_dim_lieu = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJET_SIAD_PIZZA_dim_lieu, 0, length);
				strReturn = new String(commonByteArray_PROJET_SIAD_PIZZA_dim_lieu, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJET_SIAD_PIZZA_dim_lieu) {
		...
		public int compareTo(out1Struct other) {
			...
			returnValue = checkNullsAndCompare(this.sk_lieu, other.sk_lieu);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tDBOutput_1 = "dim_lieu";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:GQ+ZvL8p5WrSg3JuKBsSbvqNp0GB9ApU7u9Nkg==");
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables("dw_projet_pizza", null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equalsIgnoreCase("dim_lieu")) {
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
								+ "`(`sk_lieu` INT(30)   not null ,`address` VARCHAR(39)  ,primary key(`sk_lieu`))");
					}
				}
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement("SELECT COUNT(1) FROM `" + "dim_lieu" + "` WHERE `sk_lieu` = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO `" + "dim_lieu" + "` (`sk_lieu`,`address`) VALUES (?,?)";

				java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement(insert_tDBOutput_1);
				resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
				String update_tDBOutput_1 = "UPDATE `" + "dim_lieu" + "` SET `address` = ? WHERE `sk_lieu` = ?";
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:zkJnehgreCLD6HsxAdTjJHdH12C9W7Zt3i3Qnw==");
...
// # Output table : 'out1'
							out1_tmp.sk_lieu = Numeric.sequence("s1", 1, 1);
...
// Start of branch "out1"
						if (out1 != null) {
							...
							pstmt_tDBOutput_1.setInt(1, out1.sk_lieu);
							...
							if (checkCount_tDBOutput_1 > 0) {
								if (out1.address == null) {
									...
									pstmtUpdate_tDBOutput_1.setString(1, out1.address);
								}

								pstmtUpdate_tDBOutput_1.setInt(2 + count_tDBOutput_1, out1.sk_lieu);
								...
								pstmtInsert_tDBOutput_1.setInt(1, out1.sk_lieu);

								if (out1.address == null) {
									pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(2, out1.address);
								}
...
// ###############################      
	...
	public static void main(String[] args) {
		final dim_lieu dim_lieuClass = new dim_lieu();

		int exitCode = dim_lieuClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dim_lieu.class.getClassLoader()
					.getResourceAsStream("projet_siad_pizza/dim_lieu_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dim_lieu.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : dim_lieu");
		}
...
/************************************************************************************************
 * 66066 characters generated by Talend Open Studio for Data Integration on the
 * January 2, 2022 10:48:38 PM WAT
 ************************************************************************************************/