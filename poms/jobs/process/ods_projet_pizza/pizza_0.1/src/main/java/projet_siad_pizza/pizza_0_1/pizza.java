...
package projet_siad_pizza.pizza_0_1;
 ...
 * @status
 */
public class pizza implements TalendJob {
	...
	private final String jobName = "pizza";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(pizza.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out2Struct implements routines.system.IPersistableRow<out2Struct> {
		final static byte[] commonByteArrayLock_PROJET_SIAD_PIZZA_pizza = new byte[0];
		static byte[] commonByteArray_PROJET_SIAD_PIZZA_pizza = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJET_SIAD_PIZZA_pizza.length) {
					if (length < 1024 && commonByteArray_PROJET_SIAD_PIZZA_pizza.length == 0) {
						commonByteArray_PROJET_SIAD_PIZZA_pizza = new byte[1024];
					} else {
						commonByteArray_PROJET_SIAD_PIZZA_pizza = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJET_SIAD_PIZZA_pizza, 0, length);
				strReturn = new String(commonByteArray_PROJET_SIAD_PIZZA_pizza, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJET_SIAD_PIZZA_pizza) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String tableName_tDBOutput_1 = "pizza";
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:BLzij5noKVuZSjic8TqnR5geGjbfULk09pvVGw==");
				...
				try (java.sql.ResultSet rsTable_tDBOutput_1 = dbMetaData_tDBOutput_1.getTables("ods_projet_pizza", null,
					...
					while (rsTable_tDBOutput_1.next()) {
						...
						if (table_tDBOutput_1.equalsIgnoreCase("pizza")) {
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
								+ "`(`id` VARCHAR(20)   not null ,`address` VARCHAR(39)  ,`categories` VARCHAR(25)  ,`city` VARCHAR(29)  ,`country` VARCHAR(46)  ,`keys` VARCHAR(57)  ,`latitude` VARCHAR(43)  ,`longitude` VARCHAR(53)  ,`menuPageURL` VARCHAR(14)  ,`menus_amountMax` VARCHAR(36)  ,`menus_amountMin` VARCHAR(41)  ,`menus_currency` VARCHAR(37)  ,`menus_dateSeen` VARCHAR(65)  ,`menus_description` VARCHAR(38)  ,`menus_name` VARCHAR(21)  ,`name` VARCHAR(35)  ,`postalCode` VARCHAR(82)  ,`priceRangeCurrency` VARCHAR(31)  ,`priceRangeMin` VARCHAR(51)  ,`priceRangeMax` VARCHAR(21)  ,`province` VARCHAR(24)  ,`Column21` VARCHAR(25)  ,`Column22` VARCHAR(26)  ,`Column23` VARCHAR(39)  ,`Column24` VARCHAR(20)  ,`Column25` VARCHAR(26)  ,`Column26` VARCHAR(9)  ,`Column27` VARCHAR(3)  ,`Column28` VARCHAR(2)  ,`Column29` VARCHAR(2)  ,`Column30` VARCHAR(2)  ,primary key(`id`))");
					}
				}
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement("SELECT COUNT(1) FROM `" + "pizza" + "` WHERE `id` = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO `" + "pizza"
						+ "` (`id`,`address`,`categories`,`city`,`country`,`keys`,`latitude`,`longitude`,`menuPageURL`,`menus_amountMax`,`menus_amountMin`,`menus_currency`,`menus_dateSeen`,`menus_description`,`menus_name`,`name`,`postalCode`,`priceRangeCurrency`,`priceRangeMin`,`priceRangeMax`,`province`,`Column21`,`Column22`,`Column23`,`Column24`,`Column25`,`Column26`,`Column27`,`Column28`,`Column29`,`Column30`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";

				java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement(insert_tDBOutput_1);
				resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
				String update_tDBOutput_1 = "UPDATE `" + "pizza"
						+ "` SET `address` = ?,`categories` = ?,`city` = ?,`country` = ?,`keys` = ?,`latitude` = ?,`longitude` = ?,`menuPageURL` = ?,`menus_amountMax` = ?,`menus_amountMin` = ?,`menus_currency` = ?,`menus_dateSeen` = ?,`menus_description` = ?,`menus_name` = ?,`name` = ?,`postalCode` = ?,`priceRangeCurrency` = ?,`priceRangeMin` = ?,`priceRangeMax` = ?,`province` = ?,`Column21` = ?,`Column22` = ?,`Column23` = ?,`Column24` = ?,`Column25` = ?,`Column26` = ?,`Column27` = ?,`Column28` = ?,`Column29` = ?,`Column30` = ? WHERE `id` = ?";
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Users/muath/Desktop/pizza/pizza.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/muath/Desktop/pizza/pizza.csv", "UTF-8", ",", "\n", false, 1, 0,
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row1.Column22 = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
// # Output table : 'out2'
								out2_tmp.id = row1.id;
								out2_tmp.address = row1.address;
								out2_tmp.categories = row1.categories;
								out2_tmp.city = row1.city;
								out2_tmp.country = row1.country;
								out2_tmp.keys = row1.keys;
								out2_tmp.latitude = row1.latitude;
								out2_tmp.longitude = row1.longitude;
								out2_tmp.menuPageURL = row1.menuPageURL;
								out2_tmp.menus_amountMax = row1.menus_amountMax;
								out2_tmp.menus_amountMin = row1.menus_amountMin;
								out2_tmp.menus_currency = row1.menus_currency;
								out2_tmp.menus_dateSeen = row1.menus_dateSeen;
								out2_tmp.menus_description = row1.menus_description;
								out2_tmp.menus_name = row1.menus_name;
								out2_tmp.name = row1.name;
								out2_tmp.postalCode = row1.postalCode;
								out2_tmp.priceRangeCurrency = row1.priceRangeCurrency;
								out2_tmp.priceRangeMin = row1.priceRangeMin;
								out2_tmp.priceRangeMax = row1.priceRangeMax;
								out2_tmp.province = row1.province;
								out2_tmp.Column21 = row1.Column21;
								out2_tmp.Column22 = row1.Column22;
								out2_tmp.Column23 = row1.Column23;
								out2_tmp.Column24 = row1.Column24;
								out2_tmp.Column25 = row1.Column25;
								out2_tmp.Column26 = row1.Column26;
								out2_tmp.Column27 = row1.Column27;
								out2_tmp.Column28 = row1.Column28;
								out2_tmp.Column29 = row1.Column29;
								out2_tmp.Column30 = row1.Column30;
								out2 = out2_tmp;
// ###############################
...
// Start of branch "out2"
							if (out2 != null) {
								...
								if (out2.id == null) {
									...
									pstmt_tDBOutput_1.setString(1, out2.id);
								}
								...
								if (checkCount_tDBOutput_1 > 0) {
									if (out2.address == null) {
										pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(1, out2.address);
									}

									if (out2.categories == null) {
										pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(2, out2.categories);
									}

									if (out2.city == null) {
										pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(3, out2.city);
									}

									if (out2.country == null) {
										pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(4, out2.country);
									}

									if (out2.keys == null) {
										pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(5, out2.keys);
									}

									if (out2.latitude == null) {
										pstmtUpdate_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(6, out2.latitude);
									}

									if (out2.longitude == null) {
										pstmtUpdate_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(7, out2.longitude);
									}

									if (out2.menuPageURL == null) {
										pstmtUpdate_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(8, out2.menuPageURL);
									}

									if (out2.menus_amountMax == null) {
										pstmtUpdate_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(9, out2.menus_amountMax);
									}

									if (out2.menus_amountMin == null) {
										pstmtUpdate_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(10, out2.menus_amountMin);
									}

									if (out2.menus_currency == null) {
										pstmtUpdate_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(11, out2.menus_currency);
									}

									if (out2.menus_dateSeen == null) {
										pstmtUpdate_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(12, out2.menus_dateSeen);
									}

									if (out2.menus_description == null) {
										pstmtUpdate_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(13, out2.menus_description);
									}

									if (out2.menus_name == null) {
										pstmtUpdate_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(14, out2.menus_name);
									}

									if (out2.name == null) {
										pstmtUpdate_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(15, out2.name);
									}

									if (out2.postalCode == null) {
										pstmtUpdate_tDBOutput_1.setNull(16, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(16, out2.postalCode);
									}

									if (out2.priceRangeCurrency == null) {
										pstmtUpdate_tDBOutput_1.setNull(17, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(17, out2.priceRangeCurrency);
									}

									if (out2.priceRangeMin == null) {
										pstmtUpdate_tDBOutput_1.setNull(18, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(18, out2.priceRangeMin);
									}

									if (out2.priceRangeMax == null) {
										pstmtUpdate_tDBOutput_1.setNull(19, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(19, out2.priceRangeMax);
									}

									if (out2.province == null) {
										pstmtUpdate_tDBOutput_1.setNull(20, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(20, out2.province);
									}

									if (out2.Column21 == null) {
										pstmtUpdate_tDBOutput_1.setNull(21, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(21, out2.Column21);
									}

									if (out2.Column22 == null) {
										pstmtUpdate_tDBOutput_1.setNull(22, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(22, out2.Column22);
									}

									if (out2.Column23 == null) {
										pstmtUpdate_tDBOutput_1.setNull(23, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(23, out2.Column23);
									}

									if (out2.Column24 == null) {
										pstmtUpdate_tDBOutput_1.setNull(24, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(24, out2.Column24);
									}

									if (out2.Column25 == null) {
										pstmtUpdate_tDBOutput_1.setNull(25, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(25, out2.Column25);
									}

									if (out2.Column26 == null) {
										pstmtUpdate_tDBOutput_1.setNull(26, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(26, out2.Column26);
									}

									if (out2.Column27 == null) {
										pstmtUpdate_tDBOutput_1.setNull(27, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(27, out2.Column27);
									}

									if (out2.Column28 == null) {
										pstmtUpdate_tDBOutput_1.setNull(28, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(28, out2.Column28);
									}

									if (out2.Column29 == null) {
										pstmtUpdate_tDBOutput_1.setNull(29, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(29, out2.Column29);
									}

									if (out2.Column30 == null) {
										pstmtUpdate_tDBOutput_1.setNull(30, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(30, out2.Column30);
									}

									if (out2.id == null) {
										pstmtUpdate_tDBOutput_1.setNull(31 + count_tDBOutput_1, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(31 + count_tDBOutput_1, out2.id);
									}
									...
									if (out2.id == null) {
										...
										pstmtInsert_tDBOutput_1.setString(1, out2.id);
									}

									if (out2.address == null) {
										pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(2, out2.address);
									}

									if (out2.categories == null) {
										pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(3, out2.categories);
									}

									if (out2.city == null) {
										pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(4, out2.city);
									}

									if (out2.country == null) {
										pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(5, out2.country);
									}

									if (out2.keys == null) {
										pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(6, out2.keys);
									}

									if (out2.latitude == null) {
										pstmtInsert_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(7, out2.latitude);
									}

									if (out2.longitude == null) {
										pstmtInsert_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(8, out2.longitude);
									}

									if (out2.menuPageURL == null) {
										pstmtInsert_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(9, out2.menuPageURL);
									}

									if (out2.menus_amountMax == null) {
										pstmtInsert_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(10, out2.menus_amountMax);
									}

									if (out2.menus_amountMin == null) {
										pstmtInsert_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(11, out2.menus_amountMin);
									}

									if (out2.menus_currency == null) {
										pstmtInsert_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(12, out2.menus_currency);
									}

									if (out2.menus_dateSeen == null) {
										pstmtInsert_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(13, out2.menus_dateSeen);
									}

									if (out2.menus_description == null) {
										pstmtInsert_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(14, out2.menus_description);
									}

									if (out2.menus_name == null) {
										pstmtInsert_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(15, out2.menus_name);
									}

									if (out2.name == null) {
										pstmtInsert_tDBOutput_1.setNull(16, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(16, out2.name);
									}

									if (out2.postalCode == null) {
										pstmtInsert_tDBOutput_1.setNull(17, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(17, out2.postalCode);
									}

									if (out2.priceRangeCurrency == null) {
										pstmtInsert_tDBOutput_1.setNull(18, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(18, out2.priceRangeCurrency);
									}

									if (out2.priceRangeMin == null) {
										pstmtInsert_tDBOutput_1.setNull(19, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(19, out2.priceRangeMin);
									}

									if (out2.priceRangeMax == null) {
										pstmtInsert_tDBOutput_1.setNull(20, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(20, out2.priceRangeMax);
									}

									if (out2.province == null) {
										pstmtInsert_tDBOutput_1.setNull(21, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(21, out2.province);
									}

									if (out2.Column21 == null) {
										pstmtInsert_tDBOutput_1.setNull(22, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(22, out2.Column21);
									}

									if (out2.Column22 == null) {
										pstmtInsert_tDBOutput_1.setNull(23, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(23, out2.Column22);
									}

									if (out2.Column23 == null) {
										pstmtInsert_tDBOutput_1.setNull(24, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(24, out2.Column23);
									}

									if (out2.Column24 == null) {
										pstmtInsert_tDBOutput_1.setNull(25, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(25, out2.Column24);
									}

									if (out2.Column25 == null) {
										pstmtInsert_tDBOutput_1.setNull(26, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(26, out2.Column25);
									}

									if (out2.Column26 == null) {
										pstmtInsert_tDBOutput_1.setNull(27, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(27, out2.Column26);
									}

									if (out2.Column27 == null) {
										pstmtInsert_tDBOutput_1.setNull(28, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(28, out2.Column27);
									}

									if (out2.Column28 == null) {
										pstmtInsert_tDBOutput_1.setNull(29, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(29, out2.Column28);
									}

									if (out2.Column29 == null) {
										pstmtInsert_tDBOutput_1.setNull(30, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(30, out2.Column29);
									}

									if (out2.Column30 == null) {
										pstmtInsert_tDBOutput_1.setNull(31, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(31, out2.Column30);
									}
					...
					if (!((Object) ("C:/Users/muath/Desktop/pizza/pizza.csv") instanceof java.io.InputStream)) {
...
// ###############################      
	...
	public static void main(String[] args) {
		final pizza pizzaClass = new pizza();

		int exitCode = pizzaClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = pizza.class.getClassLoader()
					.getResourceAsStream("projet_siad_pizza/pizza_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = pizza.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : pizza");
		}
...
/************************************************************************************************
 * 87096 characters generated by Talend Open Studio for Data Integration on the
 * January 2, 2022 10:46:15 PM WAT
 ************************************************************************************************/